...
6. Admin user yaratish (optional)
...
/api/users/register/	Foydalanuvchi ro‘yxatdan o‘tishi	Barcha foydalanuvchilar
/api/users/login/	JWT login	Barcha foydalanuvchilar
